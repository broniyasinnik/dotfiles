...
# User configuration
# controls whether the cursor style is changed when switching to a different input mode. Set it to true to enable it
...
#Alias to Apps
alias cheatsheets='~/.local/bin/cheatsheets'
